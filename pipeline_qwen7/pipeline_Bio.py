...
commands_group = [
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct/BioInstruct_Qwen2.5-7B-Instruct_0.01",'--no-dry-run'],
    ...
    #  ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct/BioInstruct_Qwen2.5-7B-Instruct_0.05",'--no-dry-run'],
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct/BioInstruct_Qwen2.5-7B-Instruct_0.10",'--no-dry-run'],
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct/BioInstruct_Qwen2.5-7B-Instruct_full",'--no-dry-run'],
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_0.01",'--no-dry-run'],
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_0.05",'--no-dry-run'],
    ...
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_0.10",'--no-dry-run'],
    ...
    # ],
    # [
    #     ['llamafactory-cli', 'train', 'examples/train_full_qwen/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full.yaml'],
    #     ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full",'--no-dry-run'],
    #     ['python', 'all_eval.py', '--model_path', 'model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full'],
    #     ['python', "eval/mmlu_eval.py", "--save_dir",
    #      "eval_result/mmlu/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full", '--model_name_or_path',
    #      'model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full'],
    #     ['python', "eval/tydiqa_eval.py", "--save_dir",
    #      "eval_result/tydiqa/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full", '--model_name_or_path',
    #      'model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full'],
    #     ['python', "eval/bbh_eval.py", "--save_dir",
    #      "eval_result/bbh/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full", '--model_name_or_path',
    #      'model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full'],
    #     ['rm', '-rf', 'model_result/BioInstruct_MASK/BioInstruct_Qwen2.5-7B-Instruct_full']
    # ],
    [
        ['llamafactory-cli', 'train', 'examples/train_full_qwen/BioInstruct_MASK_LOSS/BioInstruct_Qwen2.5-7B-Instruct_0.05.yaml'],
        ['python', 'delete_checkpoint.py', '--root_dir', "model_result/BioInstruct_MASK_LOSS/BioInstruct_Qwen2.5-0.5B-Instruct_0.05",'--no-dry-run'],
        ['python', 'all_eval.py', '--model_path', 'model_result/BioInstruct_MASK_LOSS/BioInstruct_Qwen2.5-0.5B-Instruct_0.05'],
        ['rm', '-rf', 'model_result/BioInstruct_MASK_LOSS/BioInstruct_Qwen2.5-0.5B-Instruct_0.05']
    ],
    [
