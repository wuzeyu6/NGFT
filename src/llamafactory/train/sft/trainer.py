...
# 获取当前文件（trainer.py）的绝对路径
current_file = Path(__file__).absolute()  # 例如：/home/.../trainer.py
# 计算项目根目录（LLaMA-Factory-main 的路径）
project_root = current_file.parent.parent.parent.parent.parent  # 向上回退4层
# 验证路径是否正确
print("Project root:", project_root)  # 应输出 LLaMA-Factory-main 的路径
# 将项目根目录添加到 Python 路径
